# CLAUDE.md — ARCHIVE (historical, reference-only)

> **The archive companion of `CLAUDE.md`.** Created 2026-08-17 by `cc_instruction_preparation_sixth.md` Task 1, executing Rulings 1, 2 and 3 of `cowork_rulings_2026_08_17_governing_surface_split.md` over the ratification surface `ratification_surfaces/cowork_governing_surface_split_2026_08_16.md`. It receives spans moved VERBATIM out of `CLAUDE.md`, in the order they left it, each under a provenance line naming its position in the parent's pre-act blob. **NOT part of the session-start read** — read `CLAUDE.md` for what governs.
>
> **Nothing was edited in transit.** The reconciliation is re-derived by `tools/audit/gen_governing_surface_split.py --check --pair CLAUDE.md` and proves both directions: every archived span is byte-present here and absent from the parent, and moved + kept accounts for the parent's pre-act committed blob to the character (#12, preservation elsewhere-with-record on the register-split precedent).

> **From `CLAUDE.md` lines 27–37 at `1f84f5d621` (measured at `c4f15a7b32`), class `preserved-former-wording`, 1004 characters.** Moved 2026-08-17; authored per span, read in the file itself (A4).
...
> **From `CLAUDE.md` lines 62–75 at `1f84f5d621` (measured at `c4f15a7b32`), class `preserved-former-wording`, 1328 characters.** Moved 2026-08-17; authored per span, read in the file itself (A4).
...
> **From `CLAUDE.md` lines 82–89 at `1f84f5d621` (measured at `c4f15a7b32`), class `defense-and-declined-alternatives`, 742 characters.** Moved 2026-08-17; authored per span, read in the file itself (A4).
...
> **From `CLAUDE.md` lines 90–94 at `1f84f5d621` (measured at `c4f15a7b32`), class `defense-and-declined-alternatives`, 462 characters.** Moved 2026-08-17; authored per span, read in the file itself (A4).
...
> **From `CLAUDE.md` lines 467–474 at `1f84f5d621` (measured at `c4f15a7b32`), class `defense-and-declined-alternatives`, 749 characters.** Moved 2026-08-17; authored per span, read in the file itself (A4).
...
> **From `CLAUDE.md` lines 476–479 at `1f84f5d621` (measured at `c4f15a7b32`), class `defense-and-declined-alternatives`, 371 characters.** Moved 2026-08-17; authored per span, read in the file itself (A4).
...
> **From `CLAUDE.md` lines 838–842 at `1f84f5d621` (measured at `c4f15a7b32`), class `self-declared-historical-or-superseded`, 457 characters.** Moved 2026-08-17; authored per span, read in the file itself (A4).
...
> **From `CLAUDE.md` lines 1139–1146 at `1f84f5d621` (measured at `c4f15a7b32`), class `self-declared-historical-or-superseded`, 788 characters.** Moved 2026-08-17; authored per span, read in the file itself (A4).
...
> **From `CLAUDE.md` lines 1181–1187 at `1f84f5d621` (measured at `c4f15a7b32`), class `self-declared-historical-or-superseded`, 639 characters.** Moved 2026-08-17; authored per span, read in the file itself (A4).
