...
| N14 | difficulty/grading labels (syllabus, exam grades) | T-32 | *(union search 2026-07-04, record §3)* **found:** CIPI (652 pieces, Henle 1–9, MusicXML — Zenodo gated/research-only) + Mikrokosmos (147, open) + PSyllabus (7,901 exam-board-labeled recordings, no scores) + pianosyllabus.com (28k, website-only). No machine-readable ABRSM/RCM/Henle dumps exist. **T-32 caveat: all real label sources research-only/proprietary — commercial use needs a license path** |
