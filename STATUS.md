...
*Last updated: 2026-05-08 — Iter 30: Gate K — Augmented I4 inversion (rooting correction). Pattern: Augmented root-position winner (e.g. A+) beats correct first-inversion of same augmented collection (F#5/A) at tiny margin. Fix: Gate K fires when winner is Augmented bassIsRoot=true, runner-up has same bass at interval+4 from its own root (I4), runner-up quality is Augmented or Major+SharpFifth, root is diatonic to key, margin ≤ 0.20. 1 of 7 Augmented rooting targets fixed (bwv40.6 m=6: A+ → F#5/A); 2 others not fixed (bwv40.3: margin 0.56 >> threshold; bwv102.7: margin 0.22 just above threshold but case is not a genuine three-way error — music21 agrees with G+). Gate J (I↔vi/I Major ambiguity): DEFERRED — 2 correct fixes vs 32 BIR=false regressions in Baroque corpus. Net improvement: BIR=true 53→52. BIR=false: 787 (unchanged). New baselines: BIR=true=52, BIR=false=787. 407/407 composing, 53/53 notation, 11/11 pipeline snapshot tests pass.*
