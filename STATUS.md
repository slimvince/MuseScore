...
- Pipeline snapshot tests: 11/11 passing (1 additional test skipped —
  ...
  active goldens refreshed by Iter 94 (boundary refinements + step-bonus score deltas)
- Chord mismatch report: 4 RealDiff (pinned baseline), 127 ConventionDiff (Jazz catalog)

**BIR baselines (Baroque preset, batch path, lenient-OR align_regions; re-confirmed 2026-05-17 post-Iter-94):**
- Baroque BIR=true=43, BIR=false=33
- Jazz BIR=true=117, BIR=false=14

Iter 94 dropped Baroque BIR=false from 46 → 33 (−13, ~28% reduction) via the
w_stepIn / w_stepOut +0.10 bonus on root-position candidates with parent-scope
voice-leading context. Baroque BIR=true ticked up 41 → 43 (+2 — bucket
reclassifications, not new errors). Jazz BIR=true 114 → 117 (+3); Jazz BIR=false flat (14).
Cumulative since Iter 91: Baroque BIR=false 188 → 33 (−155, 82% reduction).
Iter 92 contributed −142 of that (joint scoring + w_complete); Iter 94 contributed
the remaining −13 (voice-leading bonuses + parent-scope plumbing).
