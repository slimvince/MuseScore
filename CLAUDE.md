...
variant-(b) root-failing run enumerations (≈**6506 / 6688 / 6522** runs Baroque/Jazz/Default), the
...
**Ratified baselines** (variant b, root-agree at 326/352 coverage;
**re-baselined at the OI-168 signature-mask fix, 2026-07-14** — dispatch user-ratified 2026-07-13):
**root-agree 66.04 / 64.98 / 65.93 %** (Baroque/Jazz/Default), **RN-agree 46.33 / 44.10 / 46.23 %**,
**key-agree vs HOME/global 71.42 / 67.83 / 70.65 %**, **key-agree vs LOCAL 65.99 / 62.98 / 65.71 %**
(the OI-143 dual column — both computed, both tracked).

*★ THE OI-168 RE-BASELINE (2026-07-14; report `cc_oi168_fix_report.md`; outgoing reference preserved at
...
coverage; **re-baselined at the OI-168 signature-mask fix, 2026-07-14 — `cc_oi168_fix_report.md`;
every column below is unchanged at the reported two decimals, the movement being Jazz root-agree
+0.0058 pp, the Jazz run count 6689→6688 and the class-(b) hard-stop duration −480; full explanation
in block (A) above**. The prior event was the OI-132 mode-grading consolidation, user-ratified 2026-07-13 —
