# Cowork Session Handoff — ARCHIVE (historical, reference-only)

> Moved verbatim out of `cowork_handoff.md` by the 2026-07-18 doc split (`cc_instruction_doc_split.md`).
> NOT part of the session-start read — read `cowork_handoff.md` (the lean active handoff) first.
> Content below is exactly as it stood in the handoff: the session-close / entry-point blocks
> newest-first (2026-07-16 back to 2026-07-01), then the older architecture-direction,
> current-state, roadmap and iteration records, then the LLM-integration / ms-core-api /
