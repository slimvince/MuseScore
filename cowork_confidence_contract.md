...
> gap-analysis** (`records/cc/instructions/cc_instruction_gap_analysis_spec_vs_impl.md`, Rider 3/6) — items depending on it are marked
> **[as-built: verify]**.
