...
<museScore version="5.00">
  <Style>
    ...
    <instrumentNamesShowTranspositionLong>1</instrumentNamesShowTranspositionLong>
    <instrumentNamesShowTranspositionShort>1</instrumentNamesShowTranspositionShort>
    <instrumentNamesFormatLong>name-in-transp-num</instrumentNamesFormatLong>
    <instrumentNamesCustomFormatLong>$name in $transposition $number</instrumentNamesCustomFormatLong>
    <instrumentNamesFormatShort>name-in-transp-num</instrumentNamesFormatShort>
    <instrumentNamesCustomFormatShort>$name in $transposition $number</instrumentNamesCustomFormatShort>
    <instrumentNamesAlignLong>right-right</instrumentNamesAlignLong>
    <instrumentNamesAlignShort>right-right</instrumentNamesAlignShort>
    <instrumentNamesStackVertically>0</instrumentNamesStackVertically>
    <windsNameByGroup>0</windsNameByGroup>
    <vocalsNameByGroup>0</vocalsNameByGroup>
    <stringsNameByGroup>0</stringsNameByGroup>
    <othersNameByGroup>0</othersNameByGroup>
    ...
    <longInstrumentAlign>right,baseline</longInstrumentAlign>
    ...
    <shortInstrumentAlign>right,baseline</shortInstrumentAlign>
