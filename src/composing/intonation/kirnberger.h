...
// MuseScore Studio — Kirnberger III Well Temperament tuning system
#pragma once
...
/**
 * @brief Kirnberger III Well Temperament.
 *
 * Another historically important irregular temperament (c. 1779) designed for
 * expressive key color and full modulation. Used by C.P.E. Bach and others.
 *
 ...
 *
 * The mapping below is for Kirnberger III, with C as tonic. For other tonics,
 * the mapping is rotated accordingly.
 *
 * Reference: https://en.wikipedia.org/wiki/Kirnberger_temperament
 */
...
public:
    ...
    {
        // Kirnberger III deviations from 12-TET in cents for C major tonic.
