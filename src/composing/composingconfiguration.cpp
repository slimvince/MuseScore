...
//
// modePriorPresets() now lives in composing/analysis/key/modepriorpresets.cpp
// (composing_analysis) so tools/batch_analyze.cpp can call the same table.
// See docs/duplication_audit.md §5.8.
