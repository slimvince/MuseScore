...
- Read members: **114** of **237** (read share 0.481).
- UNDETERMINED among the read: **17** (share of the read 0.1491).

## The widened population

- **237 hunks** across **64 commits** and **17 documents** — **32** already screened and inherited, **205** new.
- By verdict: NOT YET READ 123, POSITIVELY CODE-INFLUENCED 41, RATIFIED-ACT EDIT 44, RESTRUCTURING-SHAPED 12, UNDETERMINED 17.
...
|---|---|---|---|---|---|---|---|---|---|---|
| `ARCHITECTURE.md` | 152 | 109 | 40 | 42 | 12 | 15 | 43 | 0 | — | MEASURED |
