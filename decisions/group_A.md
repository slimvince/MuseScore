...
**Home.** `CLAUDE.md:134-136`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:144-146`  — a project-wide convention with no owning layer; this is its correct home.
