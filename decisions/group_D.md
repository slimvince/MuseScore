...
**Home.** `docs/scoring_model.md:1321-1335`
...
**Home.** `docs/scoring_model.md:1336-1346`
...
**Home.** `CLAUDE.md:1013-1022`  — a decision about how the work is done, not about the system; this is its correct home.
