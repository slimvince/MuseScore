...
**Home.** `ARCHITECTURE.md:4142-4143`
...
**Home.** `ARCHITECTURE.md:1461-1463`
...
**Home.** `CLAUDE.md:1038`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1236`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1232`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:307`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:334`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:328`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:357`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:373`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:393-407`  — a decision about how the work is done, not about the system; this is its correct home.
