...
**Home.** `CLAUDE.md:476`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:503`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:526`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:618-632`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:387-395`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:561-572`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:583-601`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:602-616`  — a decision about how the work is done, not about the system; this is its correct home.
