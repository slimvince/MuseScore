...
**Home.** `CLAUDE.md:1446`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1442`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1522`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:492`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:486`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:515`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:531`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:607-621`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1497-1508`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:376-384`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:550-561`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:572-590`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:591-605`  — a decision about how the work is done, not about the system; this is its correct home.
