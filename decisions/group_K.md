...
**Home.** `ARCHITECTURE.md:4172-4173`
...
**Home.** `ARCHITECTURE.md:1491-1493`
...
**Home.** `CLAUDE.md:335`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:362`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:356`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:385`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:401`  — a decision about how the work is done, not about the system; this is its correct home.
