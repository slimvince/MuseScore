...
**Home.** `CLAUDE.md:1510`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1506`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1586`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1561-1572`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:420-428`  — a decision about how the work is done, not about the system; this is its correct home.
