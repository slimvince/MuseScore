...
**Home.** `CLAUDE.md:987`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:983`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1039`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:223`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:250`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:244`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:273`  — a decision about how the work is done, not about the system; this is its correct home.
