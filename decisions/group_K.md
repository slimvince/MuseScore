...
**Home.** `CLAUDE.md:998`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1192`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:286`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:313`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:336`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:352`  — a decision about how the work is done, not about the system; this is its correct home.
