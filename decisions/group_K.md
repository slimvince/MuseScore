...
**Home.** `CLAUDE.md:735`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:927`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:923`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:979`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:231`  — a decision about how the work is done, not about the system; this is its correct home.
