...
**Home.** `CLAUDE.md:1259`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:459`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:480`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:525`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:601-615`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:544-555`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:566-584`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:585-599`  — a decision about how the work is done, not about the system; this is its correct home.
