...
**Home.** `CLAUDE.md:1228`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1426`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1422`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1502`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:428`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:455`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:449`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:478`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:494`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:570-584`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1477-1488`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:379-387`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:513-524`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:535-553`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:554-568`  — a decision about how the work is done, not about the system; this is its correct home.
