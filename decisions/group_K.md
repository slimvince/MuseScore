...
**Home.** `CLAUDE.md:1047`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1043`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1099`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:248`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:275`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:269`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:298`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:314`  — a decision about how the work is done, not about the system; this is its correct home.
