...
**Home section.** **“`dim7CharacteristicBonus`”** — `### `dim7CharacteristicBonus` — `kDim7CharacteristicBonus = 0.75`` (heading at line 246). A delegation at CLAUDE.md:1079 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
