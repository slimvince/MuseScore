...
**Home.** `ARCHITECTURE.md:1675-1678`
...
**Home.** `ARCHITECTURE.md:1689-1690`
...
**Home.** `ARCHITECTURE.md:3095-3097`
...
**Home.** `ARCHITECTURE.md:3043-3044`
...
**Home.** `ARCHITECTURE.md:4040-4042`
...
**Home.** `ARCHITECTURE.md:4060-4061`
...
**Home.** `ARCHITECTURE.md:3049-3053`
...
**Home.** `ARCHITECTURE.md:1614-1616`
...
**Home section.** **§1** — `## 1. Introduction & purpose` (heading at line 52). A delegation at ARCHITECTURE.md:1610 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§2** — `## 2. Constraints` (heading at line 138). A delegation at ARCHITECTURE.md:1610 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§5** — `## 5. Building-block view (static / internal structure)` (heading at line 224). A delegation at ARCHITECTURE.md:1610 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§9** — `## 9. Architecture decisions (with the alternatives we weighed)` (heading at line 295). A delegation at ARCHITECTURE.md:1610 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§4** — `## 4. Solution strategy` (heading at line 206). A delegation at ARCHITECTURE.md:1610 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§10** — `## 10. Quality & testing` (heading at line 317). A delegation at ARCHITECTURE.md:1610 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§11** — `## 11. Risks & technical debt` (heading at line 349). A delegation at ARCHITECTURE.md:1610 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§15** — `## 15. To do — deferred enhancements (this layer is built; these are revisions on record)` (heading at line 480). A delegation at ARCHITECTURE.md:1610 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:1997-2005`
...
**Home.** `ARCHITECTURE.md:4078-4087`
...
**Home.** `ARCHITECTURE.md:1760-1776`
...
**Home.** `ARCHITECTURE.md:5346-5353`
...
**Home.** `ARCHITECTURE.md:5354-5361`
...
**Home.** `ARCHITECTURE.md:5362-5370`
...
**Home.** `ARCHITECTURE.md:5371-5386`
...
**Home.** `ARCHITECTURE.md:5387-5395`
...
**Home.** `ARCHITECTURE.md:5304-5312`
...
**Home.** `ARCHITECTURE.md:1722-1736`
...
**Home.** `ARCHITECTURE.md:1737-1748`
