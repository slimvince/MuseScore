...
**Home.** `ARCHITECTURE.md:1744-1747`
...
**Home.** `ARCHITECTURE.md:1758-1759`
...
**Home.** `ARCHITECTURE.md:3215-3217`
...
**Home.** `ARCHITECTURE.md:3163-3164`
...
**Home.** `ARCHITECTURE.md:4160-4162`
...
**Home.** `ARCHITECTURE.md:4180-4181`
...
**Home.** `ARCHITECTURE.md:3169-3173`
...
**Home.** `ARCHITECTURE.md:1674-1678`
...
**Home.** `ARCHITECTURE.md:1683-1685`
...
**Home section.** **“`dim7CharacteristicBonus`”** — `### `dim7CharacteristicBonus` — `kDim7CharacteristicBonus = 0.75`` (heading at line 246). A delegation at CLAUDE.md:1029 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§1** — `## 1. Introduction & purpose` (heading at line 52). A delegation at ARCHITECTURE.md:1654 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§2** — `## 2. Constraints` (heading at line 138). A delegation at ARCHITECTURE.md:1654 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§5** — `## 5. Building-block view (static / internal structure)` (heading at line 224). A delegation at ARCHITECTURE.md:1654 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§9** — `## 9. Architecture decisions (with the alternatives we weighed)` (heading at line 295). A delegation at ARCHITECTURE.md:1654 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§4** — `## 4. Solution strategy` (heading at line 206). A delegation at ARCHITECTURE.md:1654 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§10** — `## 10. Quality & testing` (heading at line 317). A delegation at ARCHITECTURE.md:1654 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§11** — `## 11. Risks & technical debt` (heading at line 349). A delegation at ARCHITECTURE.md:1654 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§15** — `## 15. To do — deferred enhancements (this layer is built; these are revisions on record)` (heading at line 480). A delegation at ARCHITECTURE.md:1654 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:2066-2074`
...
**Home.** `ARCHITECTURE.md:1829-1845`
...
**Home.** `ARCHITECTURE.md:5466-5473`
...
**Home.** `ARCHITECTURE.md:5474-5481`
...
**Home.** `ARCHITECTURE.md:5482-5490`
...
**Home.** `ARCHITECTURE.md:5491-5506`
...
**Home.** `ARCHITECTURE.md:5507-5515`
...
**Home.** `ARCHITECTURE.md:5424-5432`
...
**Home.** `ARCHITECTURE.md:1791-1805`
...
**Home.** `ARCHITECTURE.md:1806-1817`
