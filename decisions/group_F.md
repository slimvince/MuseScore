...
**Home.** `ARCHITECTURE.md:1714-1717`
...
**Home.** `ARCHITECTURE.md:1728-1729`
...
**Home.** `ARCHITECTURE.md:3134-3136`
...
**Home.** `ARCHITECTURE.md:3082-3083`
...
**Home.** `ARCHITECTURE.md:4079-4081`
...
**Home.** `ARCHITECTURE.md:4099-4100`
...
**Home.** `ARCHITECTURE.md:3088-3092`
...
**Home.** `ARCHITECTURE.md:1644-1648`
...
**Home.** `ARCHITECTURE.md:1653-1655`
...
**Home section.** **§1** — `## 1. Introduction & purpose` (heading at line 52). A delegation at ARCHITECTURE.md:1624 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§2** — `## 2. Constraints` (heading at line 138). A delegation at ARCHITECTURE.md:1624 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§5** — `## 5. Building-block view (static / internal structure)` (heading at line 224). A delegation at ARCHITECTURE.md:1624 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§9** — `## 9. Architecture decisions (with the alternatives we weighed)` (heading at line 295). A delegation at ARCHITECTURE.md:1624 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§4** — `## 4. Solution strategy` (heading at line 206). A delegation at ARCHITECTURE.md:1624 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§10** — `## 10. Quality & testing` (heading at line 317). A delegation at ARCHITECTURE.md:1624 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§11** — `## 11. Risks & technical debt` (heading at line 349). A delegation at ARCHITECTURE.md:1624 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§15** — `## 15. To do — deferred enhancements (this layer is built; these are revisions on record)` (heading at line 480). A delegation at ARCHITECTURE.md:1624 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:2036-2044`
...
**Home.** `ARCHITECTURE.md:4117-4126`
...
**Home.** `ARCHITECTURE.md:1799-1815`
...
**Home.** `ARCHITECTURE.md:5385-5392`
...
**Home.** `ARCHITECTURE.md:5393-5400`
...
**Home.** `ARCHITECTURE.md:5410-5425`
...
**Home.** `ARCHITECTURE.md:5426-5434`
...
**Home.** `ARCHITECTURE.md:5343-5351`
...
**Home.** `ARCHITECTURE.md:1761-1775`
...
**Home.** `ARCHITECTURE.md:1776-1787`
