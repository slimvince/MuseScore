...
**Home.** `ARCHITECTURE.md:2902-2904`
...
**Home.** `ARCHITECTURE.md:2574-2578`
...
**Home.** `ARCHITECTURE.md:2801-2804`
...
**Home.** `ARCHITECTURE.md:2279-2281`
...
**Home.** `ARCHITECTURE.md:2342-2345`
...
**Home.** `ARCHITECTURE.md:3332-3333`
...
**Home.** `ARCHITECTURE.md:2751-2752`
...
**Home.** `ARCHITECTURE.md:2652-2654`
...
**Home.** `ARCHITECTURE.md:2963-2964`
...
**Home.** `ARCHITECTURE.md:4777-4778`
...
**Home.** `ARCHITECTURE.md:4558-4559`
...
**Home.** `ARCHITECTURE.md:1949-1950`
...
**Home.** `ARCHITECTURE.md:5642-5645`
...
**Home.** `ARCHITECTURE.md:3417-3419`
...
**Home.** `ARCHITECTURE.md:3428-3432`
...
**Home.** `ARCHITECTURE.md:3573-3577`
...
**Home.** `ARCHITECTURE.md:3582-3589`
...
**Home.** `ARCHITECTURE.md:3629-3630`
...
**Home.** `ARCHITECTURE.md:3657-3659`
...
**Home.** `ARCHITECTURE.md:1442-1447`
...
**Home.** `ARCHITECTURE.md:1905-1907`
...
**Home.** `ARCHITECTURE.md:3335-3337`
...
**Home section.** **“Floating-point tie policy”** — `### Floating-point tie policy` (heading at line 210). A delegation at CLAUDE.md:1057 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **“§6a. The unified promotion primitive `promoteToWinner()`”** — `### §6a. The unified promotion primitive `promoteToWinner()`` (heading at line 800). A delegation at CLAUDE.md:1057 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:1994-2004`
...
**Home section.** **§4** — `## 4. Solution strategy` (heading at line 204). A delegation at ARCHITECTURE.md:1888 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§8** — `## 8. Crosscutting concepts` (heading at line 386). A delegation at ARCHITECTURE.md:1888 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§15** — `## 15. Open items & deferred refinements` (heading at line 559). A delegation at ARCHITECTURE.md:1888 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§7** — `## 7. Data design` (heading at line 349). A delegation at ARCHITECTURE.md:1888 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **“§6.3 Placement”** — `### §6.3 Placement (#7): a reader-over-carry producing a distinct pedal-annotated result` (heading at line 406). A delegation at ARCHITECTURE.md:2048 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:4346-4355`
...
**Home.** `ARCHITECTURE.md:1892-1903`
...
**Home.** `ARCHITECTURE.md:1449-1456`
...
**Home.** `ARCHITECTURE.md:1568-1579`
