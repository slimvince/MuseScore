...
**Home.** `ARCHITECTURE.md:2347-2349`
...
**Home.** `ARCHITECTURE.md:2019-2023`
...
**Home.** `ARCHITECTURE.md:2246-2249`
...
**Home.** `ARCHITECTURE.md:1724-1726`
...
**Home.** `ARCHITECTURE.md:1787-1790`
...
**Home.** `ARCHITECTURE.md:2777-2778`
...
**Home.** `ARCHITECTURE.md:2196-2197`
...
**Home.** `ARCHITECTURE.md:2097-2099`
...
**Home.** `ARCHITECTURE.md:4197-4198`
...
**Home.** `ARCHITECTURE.md:3978-3979`
...
**Home.** `ARCHITECTURE.md:1541-1542`
...
**Home.** `ARCHITECTURE.md:4837-4840`
...
**Home.** `ARCHITECTURE.md:2862-2864`
...
**Home.** `ARCHITECTURE.md:3018-3022`
...
**Home.** `ARCHITECTURE.md:3027-3034`
...
**Home.** `ARCHITECTURE.md:3044-3045`
...
**Home.** `ARCHITECTURE.md:3074-3075`
...
**Home.** `ARCHITECTURE.md:3102-3104`
...
**Home.** `ARCHITECTURE.md:2780-2782`
...
**Home section.** **§4** — `## 4. Solution strategy` (heading at line 204). A delegation at ARCHITECTURE.md:1493 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§8** — `## 8. Crosscutting concepts` (heading at line 386). A delegation at ARCHITECTURE.md:1493 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§15** — `## 15. Open items & deferred refinements` (heading at line 559). A delegation at ARCHITECTURE.md:1493 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§7** — `## 7. Data design` (heading at line 349). A delegation at ARCHITECTURE.md:1493 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **“§6.3 Placement”** — `### §6.3 Placement (#7): a reader-over-carry producing a distinct pedal-annotated result` (heading at line 406). A delegation at ARCHITECTURE.md:1595 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
