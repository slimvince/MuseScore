...
**Home.** `ARCHITECTURE.md:2791-2793`
...
**Home.** `ARCHITECTURE.md:2463-2467`
...
**Home.** `ARCHITECTURE.md:2690-2693`
...
**Home.** `ARCHITECTURE.md:2168-2170`
...
**Home.** `ARCHITECTURE.md:2231-2234`
...
**Home.** `ARCHITECTURE.md:3221-3222`
...
**Home.** `ARCHITECTURE.md:2640-2641`
...
**Home.** `ARCHITECTURE.md:2541-2543`
...
**Home.** `ARCHITECTURE.md:2852-2853`
...
**Home.** `ARCHITECTURE.md:4666-4667`
...
**Home.** `ARCHITECTURE.md:4447-4448`
...
**Home.** `ARCHITECTURE.md:1889-1890`
...
**Home.** `ARCHITECTURE.md:5531-5534`
...
**Home.** `ARCHITECTURE.md:3306-3308`
...
**Home.** `ARCHITECTURE.md:3317-3321`
...
**Home.** `ARCHITECTURE.md:3462-3466`
...
**Home.** `ARCHITECTURE.md:3471-3478`
...
**Home.** `ARCHITECTURE.md:3488-3489`
...
**Home.** `ARCHITECTURE.md:3518-3519`
...
**Home.** `ARCHITECTURE.md:3546-3548`
...
**Home.** `ARCHITECTURE.md:1382-1387`
...
**Home.** `ARCHITECTURE.md:1845-1847`
...
**Home.** `ARCHITECTURE.md:3224-3226`
...
**Home.** `ARCHITECTURE.md:1934-1944`
...
**Home section.** **§4** — `## 4. Solution strategy` (heading at line 204). A delegation at ARCHITECTURE.md:1828 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§8** — `## 8. Crosscutting concepts` (heading at line 386). A delegation at ARCHITECTURE.md:1828 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§15** — `## 15. Open items & deferred refinements` (heading at line 559). A delegation at ARCHITECTURE.md:1828 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§7** — `## 7. Data design` (heading at line 349). A delegation at ARCHITECTURE.md:1828 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **“§6.3 Placement”** — `### §6.3 Placement (#7): a reader-over-carry producing a distinct pedal-annotated result` (heading at line 406). A delegation at ARCHITECTURE.md:1988 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:4235-4244`
...
**Home.** `ARCHITECTURE.md:1832-1843`
...
**Home.** `ARCHITECTURE.md:1389-1396`
...
**Home.** `ARCHITECTURE.md:1508-1519`
