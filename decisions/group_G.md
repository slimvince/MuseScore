...
**Home section.** **“Floating-point tie policy”** — `### Floating-point tie policy` (heading at line 210). A delegation at CLAUDE.md:1206 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **“§6a. The unified promotion primitive `promoteToWinner()`”** — `### §6a. The unified promotion primitive `promoteToWinner()`` (heading at line 800). A delegation at CLAUDE.md:1206 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `CLAUDE.md:1043-1045`  — a decision about how the work is done, not about the system; this is its correct home.
