...
**Home.** `ARCHITECTURE.md:2752-2754`
...
**Home.** `ARCHITECTURE.md:2424-2428`
...
**Home.** `ARCHITECTURE.md:2651-2654`
...
**Home.** `ARCHITECTURE.md:2129-2131`
...
**Home.** `ARCHITECTURE.md:2192-2195`
...
**Home.** `ARCHITECTURE.md:3182-3183`
...
**Home.** `ARCHITECTURE.md:2601-2602`
...
**Home.** `ARCHITECTURE.md:2502-2504`
...
**Home.** `ARCHITECTURE.md:2813-2814`
...
**Home.** `ARCHITECTURE.md:4627-4628`
...
**Home.** `ARCHITECTURE.md:4408-4409`
...
**Home.** `ARCHITECTURE.md:1850-1851`
...
**Home.** `ARCHITECTURE.md:5492-5495`
...
**Home.** `ARCHITECTURE.md:3267-3269`
...
**Home.** `ARCHITECTURE.md:3278-3282`
...
**Home.** `ARCHITECTURE.md:3423-3427`
...
**Home.** `ARCHITECTURE.md:3432-3439`
...
**Home.** `ARCHITECTURE.md:3449-3450`
...
**Home.** `ARCHITECTURE.md:3479-3480`
...
**Home.** `ARCHITECTURE.md:3507-3509`
...
**Home.** `ARCHITECTURE.md:1368-1373`
...
**Home.** `ARCHITECTURE.md:1806-1808`
...
**Home.** `ARCHITECTURE.md:3185-3187`
...
**Home section.** **“Floating-point tie policy”** — `### Floating-point tie policy` (heading at line 210). A delegation at CLAUDE.md:960 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **“§6a. The unified promotion primitive `promoteToWinner()`”** — `### §6a. The unified promotion primitive `promoteToWinner()`` (heading at line 800). A delegation at CLAUDE.md:960 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:1895-1905`
...
**Home section.** **§4** — `## 4. Solution strategy` (heading at line 204). A delegation at ARCHITECTURE.md:1789 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§8** — `## 8. Crosscutting concepts` (heading at line 386). A delegation at ARCHITECTURE.md:1789 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§15** — `## 15. Open items & deferred refinements` (heading at line 559). A delegation at ARCHITECTURE.md:1789 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§7** — `## 7. Data design` (heading at line 349). A delegation at ARCHITECTURE.md:1789 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **“§6.3 Placement”** — `### §6.3 Placement (#7): a reader-over-carry producing a distinct pedal-annotated result` (heading at line 406). A delegation at ARCHITECTURE.md:1949 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:4196-4205`
...
**Home.** `ARCHITECTURE.md:1793-1804`
...
**Home.** `ARCHITECTURE.md:1375-1382`
...
**Home.** `ARCHITECTURE.md:1494-1505`
