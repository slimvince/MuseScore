...
**Home.** `ARCHITECTURE.md:815-816`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `ARCHITECTURE.md:713`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `ARCHITECTURE.md:897-898`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `ARCHITECTURE.md:1372-1385`
...
**Home.** `ARCHITECTURE.md:1386-1388`
...
**Home.** `cowork_structural_integrity_audit.md:326-328`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).
...
**Home.** `ARCHITECTURE.md:7194-7205`
...
**Home.** `ARCHITECTURE.md:4326-4335`
...
**Home.** `ARCHITECTURE.md:1713-1720`
