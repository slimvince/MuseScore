...
**Home.** `ARCHITECTURE.md:821-822`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `ARCHITECTURE.md:719`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `ARCHITECTURE.md:903-904`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `ARCHITECTURE.md:1408-1421`
...
**Home.** `ARCHITECTURE.md:7230-7241`
...
**Home.** `ARCHITECTURE.md:4362-4371`
...
**Home.** `ARCHITECTURE.md:1749-1756`
