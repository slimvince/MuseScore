...
**Home.** `ARCHITECTURE.md:801-802`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `ARCHITECTURE.md:699`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `ARCHITECTURE.md:883-884`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `ARCHITECTURE.md:1328-1341`
...
**Home.** `ARCHITECTURE.md:7074-7085`
...
**Home.** `ARCHITECTURE.md:4206-4215`
...
**Home.** `ARCHITECTURE.md:1644-1651`
