...
**Home.** `CLAUDE.md:950-952`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:960-962`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:965-967`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:937-939`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:791-792`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:982-984`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1240-1242`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:826-830`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:1015-1028`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1044-1053`  — a project-wide convention with no owning layer; this is its correct home.
