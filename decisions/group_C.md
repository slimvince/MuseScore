...
**Home.** `ARCHITECTURE.md:1109-1111`
...
**Home.** `ARCHITECTURE.md:1122-1125`
...
**Home.** `ARCHITECTURE.md:1155-1156`
...
**Home.** `ARCHITECTURE.md:1179-1181`
...
**Home.** `ARCHITECTURE.md:1196-1197`
...
**Home.** `ARCHITECTURE.md:4440-4448`
...
**Home section.** **§2** — `## 2. The three spans (the core distinction)` (heading at line 33). A delegation at ARCHITECTURE.md:1118 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§3** — `## 3. The bounded-context contract (what every layer obeys)` (heading at line 51). A delegation at ARCHITECTURE.md:1118 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§4** — `## 4. The protocol — request → supply → bounded recompute` (heading at line 117). A delegation at ARCHITECTURE.md:1118 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§8** — `## 8. Risks & the non-trivial parts` (heading at line 218). A delegation at ARCHITECTURE.md:1118 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§2** — `## 2. Definitions — the two admissible confidence classes` (heading at line 23). A delegation at ARCHITECTURE.md:1173 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§4** — `## 4. The comparison frames (the §8 override arithmetic, stated once)` (heading at line 63). A delegation at ARCHITECTURE.md:1173 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:1243-1250`
...
**Home.** `ARCHITECTURE.md:1187-1189`
...
**Home section.** **§9** — `## 9. Architecture decisions (with the alternatives weighed)` (heading at line 620). A delegation at ARCHITECTURE.md:2028 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:5307-5322`
...
**Home section.** **§8** — `## 8. Which of it the KEY layer wants — and the circularity map, faced honestly` (heading at line 149). A delegation at ARCHITECTURE.md:1205 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it RECORDS FINDINGS**.
...
**Home section.** **§8b** — `## 8b. Declared future consumers, named by the user (2026-07-13)` (heading at line 206). A delegation at ARCHITECTURE.md:1205 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it RECORDS FINDINGS**.
...
**Home section.** **§8c** — `## 8c. An external evidence source, filed OPEN — music21's local key (OI-158)` (heading at line 226). A delegation at ARCHITECTURE.md:1205 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it RECORDS FINDINGS**.
...
**Home section.** **§4** — `## 4. The comparison frames (the §8 override arithmetic, stated once)` (heading at line 63). A delegation at ARCHITECTURE.md:1173 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**. Home class **re-classified 2026-08-03** (the one re-classification pass) from `gap` to `contract-home`; the former class is kept here rather than overwritten (#12).
...
**Home.** `ARCHITECTURE.md:1972-1980`
...
**Home.** `ARCHITECTURE.md:1982-1988`
...
**Home.** `ARCHITECTURE.md:1722-1729`
...
**Home.** `ARCHITECTURE.md:1544-1552`
...
**Home.** `ARCHITECTURE.md:1731-1741`
