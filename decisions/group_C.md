...
**Home.** `CLAUDE.md:1053`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:894-896`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:871-873`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:721-722`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:916-918`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:756-760`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:949-962`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:978-987`  — a project-wide convention with no owning layer; this is its correct home.
