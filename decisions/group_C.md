...
**Home.** `CLAUDE.md:736-738`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:741-743`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:713-715`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:563-564`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:758-760`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1029-1031`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:598-602`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:791-804`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:820-829`  — a project-wide convention with no owning layer; this is its correct home.
