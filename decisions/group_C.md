...
**Home.** `CLAUDE.md:676-678`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:686-688`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:663-665`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:513-514`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:708-710`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:979-981`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:548-552`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:741-754`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:770-779`  — a project-wide convention with no owning layer; this is its correct home.
