...
**Home.** `CLAUDE.md:1107`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:948-950`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:953-955`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:925-927`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:779-780`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:970-972`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1228-1230`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:814-818`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:1003-1016`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1032-1041`  — a project-wide convention with no owning layer; this is its correct home.
