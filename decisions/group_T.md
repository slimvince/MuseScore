...
**Home.** `CLAUDE.md:1979`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1459`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1411`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1432`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1836-1848`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:251-259`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:265-270`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:239-245`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1918-1936`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1961-1968`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:514`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:653`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:688`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1753-1771`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:364-385`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1775-1787`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:280-282`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:1030-1032`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1039-1041`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:612-643`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1015-1062`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1117-1150`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1154-1177`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1181-1208`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1395-1424`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:987-994`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:896-907`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:926-934`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1212-1220`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1236-1245`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1375-1383`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1428-1435`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1091-1100`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:952-961`  — a decision about how the work is done, not about the system; this is its correct home.
...
### D-658 — Where the record does not settle the question, the surface that returns it to the user gathers facts, marks what is unsettled, and carries a recommendation
...
**Home.** `cowork_audit_protocol.md:729-742`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:590-596`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1263-1269`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:863-869`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1452-1458`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1499-1504`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:1537-1541`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `cowork_audit_protocol.md:762-776`  — a decision about how the work is done, not about the system; this is its correct home.
...
> `records/cowork/rulings/cowork_rulings_2026_08_11_fifteenth_stop.md`, Ruling 65).**
...
**Home.** `CLAUDE.md:1714-1741`  — a decision about how the work is done, not about the system; this is its correct home.
...
> 2026-08-11; the ruling record is `records/cowork/rulings/cowork_rulings_2026_08_11_fifteenth_stop.md`, Ruling 66).**
...
**Home.** `CLAUDE.md:388-418`  — a decision about how the work is done, not about the system; this is its correct home.
...
> ruling record is `records/cowork/rulings/cowork_rulings_2026_08_13_seventeenth_stop.md`, Ruling 69).**
...
**Home.** `CLAUDE.md:448-496`  — a decision about how the work is done, not about the system; this is its correct home.
...
### D-678 — The derivation method is ruled USABLE for v1 on the user's ground - a first specification cannot be the ultimate one, so the best derivable from everything held except the code is good enough by construction; this supersedes the method's VOIDED status
...
**In plain words.** The method by which a first version of a specification is derived is ruled usable, on the user's own ground rather than on the held-out test that was built to judge it. His ground: a first version cannot be the ultimate one, because the sources are not exhausted until the audit against the code has run; what a first version can be is the best derivable from everything already held except the code, plus added research. Deriving it that way is therefore good enough by construction, and it improves on the current text on provenance alone, the current text being partly code-derived - which is the defect the phases exist to repair. This discharges the pilot's postcondition by the first of its three limbs and supersedes the method's earlier VOIDED status, the verdict now resting on a ground the contamination that voided the earlier one does not reach.

**Why.** The ground is the user's own, put in his framing across the sitting and recorded with the ruling; it is not the held-out test's ground. That is what makes the verdict survive the contamination that voided the earlier one: the earlier verdict rested on a test whose evidence was compromised, and this one rests on an argument from what a first version can be at all.

**Status.** LIVE · decided 2026-08-25 · ratified by user

**Home.** `records/cowork/rulings/cowork_rulings_2026_08_25_v1_sufficiency_sitting.md:13-29`  — a decision about how the work is done, not about the system; this is its correct home.

**Provenance.** User ruling of 2026-08-25, Ruling 1 of `cowork_rulings_2026_08_25_v1_sufficiency_sitting.md` (the user's word: "yes"). Entered by `cc_instruction_amendment_landing.md` Task 6 under Ruling 3 of `cowork_rulings_2026_08_26_amendment_landing_sitting.md`, which rules that this verdict is carried by the decisions register. ★ THE REGISTER IS THE HOME UNDER RULE (n), READ AT THE RULE BEFORE THIS ROW WAS WRITTEN AND NOT RELAYED. `CLAUDE.md`'s decisions-register rule (n) says an establishment verdict (#19) - that something is established, that it is not, or that the route to establishing it is exhausted - is the same KIND as supersession and shelving, that its home is the register itself with its evidence pointed at the record that measured it, and that no specification home is owed; and it says the line falls at the KIND rather than at the subject, a verdict and a supersession both being statements about the STANDING of something the record holds. NO SPECIFICATION HOME IS OWED FOR THIS ENTRY. ★ WHY THE `home` FIELD NAMES THE RULING RECORD RATHER THAN THE REGISTER, stated so a reader does not take it for a contradiction of rule (n): the register's establishment check requires an entry's quoted text to be FOUND in the file it is cited to, and a generated register file cannot be the source of its own quote - which is the ground on which the same sitting's Ruling 1 sent the three principle amendments to `CLAUDE.md` rather than to the register. The field therefore cites the record that states the verdict, which is also the evidence rule (n) requires it to point at. ★ NO REGISTER-LEVEL SUPERSESSION IS ENTERED, AND THE REASON IS MEASURED RATHER THAN ASSUMED: the register marks a supersession on the SUPERSEDED entry, and the method's VOIDED status has no register entry - searched at `tools/audit/decisions/backbone_decisions.json`, zero matches for the status word and zero for any 2026-08-25 record. What this verdict replaces is therefore recorded only in this entry's own quoted text, in the ruling's own words, and whether the superseded verdict is owed an entry of its own is left as a question for the user. Cross-ref D-679 (the independence evidence ruled in the same sitting), D-680 (the phase-status change that rests on this verdict), D-431 (no derived figure restated here).

### D-679 — A deriving session's independence from the shipped code is evidenced by the ten DIFFERS rows of the harmony-boundary comparison reading, not by the held-out test
...
**In plain words.** The held-out test stood in for a narrower worry than whether a first-version specification will be good: whether a session deriving one is genuinely independent of the shipped code, or quietly re-imports its assumptions the way the previous generation of specifications did. That worry is answered by the row-by-row comparison reading instead: on its current-text axis, ten of the blind output's twenty-six statements disagree with the shipped code, and a session covertly reading the implementation does not produce ten disagreements with it. The evidence needs no oracle, is inspectable at the file, and is untouched by the contamination that voided the held-out test. It is NOT claimed that the ten are substantive; whether they are real discrepancies worth having is open.

**Why.** Stated with the ruling. The evidence is inspectable at `ratification_surfaces/cowork_comparison_harmony_boundary_reading.md` section 6 and needs no oracle, which is exactly why it survives the contamination that voided the held-out test's verdict - the test's evidence was compromised, and this evidence is a file anyone can open. The bound is recorded beside the claim rather than discovered later: the substantiveness of the ten is open, and a first pass over it was offered at the sitting and not taken up.

**Status.** LIVE · decided 2026-08-25 · ratified by user

**Home.** `records/cowork/rulings/cowork_rulings_2026_08_25_v1_sufficiency_sitting.md:31-44`  — a decision about how the work is done, not about the system; this is its correct home.

**Provenance.** User ruling of 2026-08-25, Ruling 2 of `cowork_rulings_2026_08_25_v1_sufficiency_sitting.md`. Entered by `cc_instruction_amendment_landing.md` Task 6 under Ruling 3 of `cowork_rulings_2026_08_26_amendment_landing_sitting.md`, which rules that this verdict is carried by the decisions register. ★ THE REGISTER IS THE HOME UNDER RULE (n), READ AT THE RULE BEFORE THIS ROW WAS WRITTEN AND NOT RELAYED; the rule's own words and the reason the `home` field names the ruling record rather than the register are stated at D-678 and are not repeated here (#6). NO SPECIFICATION HOME IS OWED FOR THIS ENTRY. ★ THE FIGURE IN THE QUOTED TEXT IS THE RULING'S OWN AND IS NOT RE-MEASURED HERE (D-431): the batch that entered this row did not open either blind output and did not re-count the comparison reading, and the entry quotes rather than derives. Cross-ref D-678 (the verdict this evidence supports, ruled in the same sitting), D-680 (the phase-status change that rests on that verdict), D-431 (no derived figure restated here).

### D-680 — The framework and detail-specification phases are no longer HELD; E and C are neither the next act nor owed, and the empirical findings ledger remains owed before the framework phase
...
**In plain words.** The framework phase and the detail-specification phase were both held on the pilot's verdict about the derivation method. That verdict is now given, so the hold lapses and neither phase is held any longer. The ordering that put E first, then C with B running alongside, is superseded: E - the user's judgement of the existing derivation against the oracle - and C - the re-run of the held-out test - are not the next act and are not owed. B is untouched: the empirical findings ledger remains owed before the framework phase, exactly as it stood.

**Why.** The user's ground for setting E and C aside is recorded with the ruling as the load-bearing part: the held-out test's pass condition - reproduces the ruled intent, or a defended alternative the user would rank beside it - tests whether the output lands near a judgement he already made; it does not test design quality, and a method could pass it while producing poor engineering. The hold itself lapses rather than being lifted by a separate act, because both phases were held on the method verdict alone and Ruling 1 of the same sitting supplies it. The route was chosen over the two alternatives on the record: a standing phase-state block in `STATUS.md` was declined because that file's shape is one dated entry per batch with older entries archived, so a block that must not be archived would need an exception to a guard-enforced archiving rule, and because a living document overwrites where the register trails; a dedicated phase-state artifact was declined as a new governing document that is unread unless added to the session-start read.

**Status.** LIVE · decided 2026-08-25 · ratified by user

**Home.** `records/cowork/rulings/cowork_rulings_2026_08_25_v1_sufficiency_sitting.md:46-54`  — a decision about how the work is done, not about the system; this is its correct home.

**Provenance.** User ruling of 2026-08-25, Ruling 3 of `cowork_rulings_2026_08_25_v1_sufficiency_sitting.md`. Entered by `cc_instruction_amendment_landing.md` Task 6 under Ruling 3 of `cowork_rulings_2026_08_26_amendment_landing_sitting.md` (Alternative N; the user's word: "N"), which rules that the phase-status change is carried by the decisions register. ★ THE FINDING THAT PRODUCED THAT RULING, RECORDED HERE BECAUSE IT IS LARGER THAN THE RULING AND IS THE REASON THIS ROW EXISTS AT ALL: phase status had no home. Measured at the 2026-08-26 sitting and relayed here rather than re-measured - `HELD` and `VOIDED` return zero matches in `ratification_surfaces/cowork_phase_definition_surface_2026_08_15.md`, a concept search for phase status over the `DECISIONS.md` index returns zero, and `cowork_specification_reconstruction_plan_successor_2026_08_21.md` carries none - so the state that blocked every substantive act in this project for weeks lived only in handoff prose, the same carrier that turned one decision-surface rule into three wordings. ★ WHY THE REGISTER AND NOT A LIVING DOCUMENT: un-holding a phase is a decision, not a mechanical state, and the register supersedes rather than overwrites, so *held, then un-held on this ground* stays readable; the register is already in the session-start read, so a successor meets phase state without opening anything extra. This row does not depend on rule (n) and was not gated on it, which the dispatch states in terms. ★ NO REGISTER-LEVEL SUPERSESSION IS ENTERED FOR THE ORDERING THIS REPLACES, AND THE REASON IS MEASURED: the register marks a supersession on the SUPERSEDED entry, and Ruling 3 of `cowork_rulings_2026_08_25_regress_termination_sitting.md` has no register entry - searched at `tools/audit/decisions/backbone_decisions.json`, zero matches for that record and zero for any 2026-08-25 record. No entry was created for the superseded ruling, no `superseded_by` field was written anywhere, and what this ruling replaces is recorded only in this entry's own quoted text, in the ruling's own words. Whether the superseded ordering is owed an entry of its own is a question for the user. Cross-ref D-678 (the method verdict the hold was held on, which supplies it), D-679 (the independence evidence ruled in the same sitting), D-231 (the phase-sequencing rule this row's status change is about, and the sibling that decided this entry's group), D-431 (no derived identity or count restated here).
