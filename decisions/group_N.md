...
**Why.** Stated constraint, ARCHITECTURE.md:4273-4276: keeping the interface voicing-type agnostic is what lets a new voicing type be added as a generator implementation plus a style parameter, without the interface changing.

**Status.** LIVE · date not stated · ratifier not stated

**Home.** `ARCHITECTURE.md:4281`

**Provenance.** ARCHITECTURE.md:4268-4290 (§8.2); the principle it realizes is D-070 (§2.1). No date or ratifier stated.
...
**Home.** `ARCHITECTURE.md:4450`

**Provenance.** ARCHITECTURE.md:4412-4451 (§9.1-§9.2). No date or ratifier stated.
...
**Why.** Stated constraint, ARCHITECTURE.md:4469-4471: it exists to make musical correctness checkable by eye and ear rather than only through the automated agreement numbers.

**Status.** DEFERRED · date not stated · ratifier not stated

**Home.** `ARCHITECTURE.md:4465`

**Provenance.** ARCHITECTURE.md:4463-4553 (§10.0), whose own status line reads 'Not yet started'. No date or ratifier stated.
...
**Why.** Stated constraint, ARCHITECTURE.md:4598 and :4573: the circle of fifths and the Tonnetz were chosen partly because they carry no intellectual-property claim - the Tonnetz being a nineteenth-century mathematical structure - and the same reasoning is what forces an original layout for the functional map.

**Status.** DEFERRED · date not stated · ratifier not stated

**Home.** `ARCHITECTURE.md:4616`

**Provenance.** ARCHITECTURE.md:4595-4618 (§10.2-§10.4), all three marked planned. No date or ratifier stated.
...
**Why.** Stated constraint, ARCHITECTURE.md:4648-4650: the full playback pipeline has too much delay for interactive exploration, and the inference runs on a background thread so the interface stays responsive.

**Status.** DEFERRED · date not stated · ratifier not stated

**Home.** `ARCHITECTURE.md:4647`

**Provenance.** ARCHITECTURE.md:4620-4650 (§10.5), a planned component. No date or ratifier stated.
...
**Why.** Stated constraint, ARCHITECTURE.md:6422-6423: no proxy objects, no element handles and no lifecycle management - recorded as both the right model for this kind of interaction and the simpler one to implement.

**Status.** DEFERRED · date not stated · ratifier not stated

**Home.** `ARCHITECTURE.md:6420`

**Provenance.** ARCHITECTURE.md:6413-6423 (§19.2), a planned module; full design `docs/llm_integration.md`. No date or ratifier stated.
...
**Why.** Stated constraint, ARCHITECTURE.md:6428-6429: because the model reads what it fetches, the quality of that serialization - clean, hierarchical, beat-aligned, free of layout noise - is the critical foundation.

**Status.** DEFERRED · date not stated · ratifier not stated

**Home.** `ARCHITECTURE.md:6425`

**Provenance.** ARCHITECTURE.md:6413-6429 (§19.2), a planned module. No date or ratifier stated.
...
**Why.** Stated constraint, ARCHITECTURE.md:6435: MuseScore's own property system is the practical boundary between the two, so the split is enforceable rather than judged case by case.

**Status.** DEFERRED · date not stated · ratifier not stated

**Home.** `ARCHITECTURE.md:6431`

**Provenance.** ARCHITECTURE.md:6413-6435 (§19.2), a planned module. No date or ratifier stated.
...
**Why.** Stated constraint, ARCHITECTURE.md:6450-6452: the same analysis also drives the validation step that checks voice leading and harmonic consistency before a generated change reaches the score, so one analysis serves both directions.

**Status.** DEFERRED · date not stated · ratifier not stated

**Home.** `ARCHITECTURE.md:6444`

**Provenance.** ARCHITECTURE.md:6442-6456 (§19.3), a planned module. No date or ratifier stated.
...
**Why.** Stated constraint, ARCHITECTURE.md:6458-6463: with a properly designed plugin interface the bridge does not need to live in the core at all - it becomes optional, independently updatable, provider-agnostic and open to community alternatives - so the constraint is what keeps that end state reachable.

**Status.** DEFERRED · date not stated · ratifier not stated

**Home.** `ARCHITECTURE.md:6465`

**Provenance.** ARCHITECTURE.md:6458-6468 (§19.4), a planned module; full argument `docs/llm_integration.md` §11. No date or ratifier stated.
