...
**Home.** `ARCHITECTURE.md:2020-2021`
...
**Home.** `ARCHITECTURE.md:2024-2025`
...
**Home.** `ARCHITECTURE.md:2139-2140`
...
**Home.** `ARCHITECTURE.md:1132-1133`
...
**Home.** `ARCHITECTURE.md:7162-7164`
...
**Home.** `ARCHITECTURE.md:2106-2110`
...
**Home section.** **§7** — `## 7. Data design` (heading at line 546). A delegation at ARCHITECTURE.md:2028 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§5.0** — `### 5.0 Shared definitions (the terms the rules below stand on)` (heading at line 158). A delegation at ARCHITECTURE.md:2028 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§11** — `## 11. Risks & technical debt` (heading at line 678). A delegation at ARCHITECTURE.md:2028 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **“§4.1 Layer boundaries”** — `### §4.1 Layer boundaries (#7) — what belongs where` (heading at line 255). A delegation at ARCHITECTURE.md:2048 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **“§7.2 The vehicle”** — `### §7.2 The vehicle (#6, the load-bearing decision): unify the open-mark, do NOT add a parallel channel` (heading at line 468). A delegation at ARCHITECTURE.md:2048 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `cowork_voiceleading_axis_design.md:529-532`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).

**Home section.** **§9** — `## 9. Architecture decisions (alternatives weighed)` (heading at line 518). A delegation at ARCHITECTURE.md:1089 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `cowork_voiceleading_axis_design.md:533-535`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).
...
**Home.** `cowork_voiceleading_axis_design.md:536-539`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).
...
**Home.** `cowork_voiceleading_axis_design.md:543-551`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).
...
**Home.** `cowork_voiceleading_axis_design.md:540-542`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).
...
**Home.** `cowork_voiceleading_axis_design.md:356-361`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).

**Home section.** **§5.3** — `### 5.3 VL-C — texture classification (inference; the first judgment component)` (heading at line 348). A delegation at ARCHITECTURE.md:1089 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `cowork_voiceleading_axis_design.md:314-318`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).

**Home section.** **§5.1** — `### 5.1 VL-A — the voice-linear view (representation; facts)` (heading at line 299). A delegation at ARCHITECTURE.md:1089 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `cowork_voiceleading_axis_design.md:386-391`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).
...
**Home.** `cowork_voiceleading_axis_design.md:512-514`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).

**Home section.** **§8** — `## 8. Crosscutting concepts` (heading at line 494). A delegation at ARCHITECTURE.md:1089 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:1139-1142`
...
**Home.** `cowork_voiceleading_axis_design.md:96-99`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).

**Home section.** **“Accepted music-theory terms [MT]”** — `### Accepted music-theory terms [MT]` (heading at line 86). A delegation at ARCHITECTURE.md:1089 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:1095-1100`
...
**Home.** `ARCHITECTURE.md:5573-5583`
...
**Home section.** **the opening block (above the first section heading)** — `# Layer 6 — Grouping (design)` (heading at line 1). A delegation at ARCHITECTURE.md:2143 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it RECORDS FINDINGS**.
...
**Home.** `ARCHITECTURE.md:2145-2157`
...
**Home.** `cowork_phrase_boundary_design.md:223-226`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).

**Home section.** **§6** — `## 6. Architecture decisions (with the alternatives weighed)` (heading at line 222). A delegation at ARCHITECTURE.md:1513 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**. Home class **re-classified 2026-08-03** (the one re-classification pass) from `gap` to `contract-home`; the former class is kept here rather than overwritten (#12).
...
**Home.** `cowork_phrase_boundary_design.md:233-238`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).
...
**Home.** `cowork_phrase_boundary_design.md:239-245`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).
...
**Home.** `cowork_phrase_boundary_design.md:276-282`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).

**Home section.** **§8** — `## 8. Risks & technical debt` (heading at line 266). A delegation at ARCHITECTURE.md:1513 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**. Home class **re-classified 2026-08-03** (the one re-classification pass) from `gap` to `contract-home`; the former class is kept here rather than overwritten (#12).
...
**Home.** `cowork_phrase_boundary_design.md:176-181`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).

**Home section.** **§4.4** — `### 4.4 Peak-picking` (heading at line 175). A delegation at ARCHITECTURE.md:1513 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**. Home class **re-classified 2026-08-03** (the one re-classification pass) from `gap` to `contract-home`; the former class is kept here rather than overwritten (#12).
...
**Home.** `cowork_phrase_boundary_design.md:227-229`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).
...
**Home.** `cowork_phrase_boundary_design.md:254-258`  — homed in a RATIFIED CONTRACT SURFACE the owning `ARCHITECTURE.md` section points to: a proper home (the fifth home case, user-ratified 2026-08-02 at OI-268; its unit narrowed from the document to the SECTION by the user's ruling of 2026-08-03 — see *Home section* below where the entry carries one).

**Home section.** **§7** — `## 7. Quality & testing` (heading at line 250). A delegation at ARCHITECTURE.md:1513 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**. Home class **re-classified 2026-08-03** (the one re-classification pass) from `gap` to `contract-home`; the former class is kept here rather than overwritten (#12).
...
**Home section.** **the opening block (above the first section heading)** — `# Phrase-boundary primitive (Architectural Layer 1.5) — Architecture & Design` (heading at line 1). A delegation at ARCHITECTURE.md:1513 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it RECORDS FINDINGS**.
...
**Home section.** **§11** — `## 11. Open items` (heading at line 343). A delegation at ARCHITECTURE.md:1513 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it RECORDS FINDINGS**.
...
**Home.** `ARCHITECTURE.md:2085-2095`
...
**Home.** `ARCHITECTURE.md:2030-2046`
