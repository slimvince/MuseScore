...
**Home.** `ARCHITECTURE.md:2068-2069`
...
**Home.** `ARCHITECTURE.md:2072-2073`
...
**Home.** `ARCHITECTURE.md:2187-2188`
...
**Home.** `ARCHITECTURE.md:7233-7235`
...
**Home.** `ARCHITECTURE.md:2154-2158`
...
**Home section.** **§7** — `## 7. Data design` (heading at line 546). A delegation at ARCHITECTURE.md:2076 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§5.0** — `### 5.0 Shared definitions (the terms the rules below stand on)` (heading at line 158). A delegation at ARCHITECTURE.md:2076 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§11** — `## 11. Risks & technical debt` (heading at line 678). A delegation at ARCHITECTURE.md:2076 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **“§4.1 Layer boundaries”** — `### §4.1 Layer boundaries (#7) — what belongs where` (heading at line 255). A delegation at ARCHITECTURE.md:2096 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **“§7.2 The vehicle”** — `### §7.2 The vehicle (#6, the load-bearing decision): unify the open-mark, do NOT add a parallel channel` (heading at line 468). A delegation at ARCHITECTURE.md:2096 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§9** — `## 9. Architecture decisions (alternatives weighed)` (heading at line 534). A delegation at ARCHITECTURE.md:1137 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§5.3** — `### 5.3 VL-C — texture classification (inference; the first judgment component)` (heading at line 364). A delegation at ARCHITECTURE.md:1137 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§5.1** — `### 5.1 VL-A — the voice-linear view (representation; facts)` (heading at line 315). A delegation at ARCHITECTURE.md:1137 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home section.** **§8** — `## 8. Crosscutting concepts` (heading at line 510). A delegation at ARCHITECTURE.md:1137 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:1187-1190`
...
**Home section.** **“Accepted music-theory terms [MT]”** — `### Accepted music-theory terms [MT]` (heading at line 99). A delegation at ARCHITECTURE.md:1137 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**.
...
**Home.** `ARCHITECTURE.md:1143-1148`
...
**Home.** `ARCHITECTURE.md:5644-5654`
...
**Home.** `ARCHITECTURE.md:2193-2205`
...
**Home section.** **§6** — `## 6. Architecture decisions (with the alternatives weighed)` (heading at line 249). A delegation at ARCHITECTURE.md:1561 reaches this section. Decided by **D-430, the section-level unit — the delegation reaches this section and it STATES RULES**. Home class **re-classified 2026-08-03** (the one re-classification pass) from `gap` to `contract-home`; the former class is kept here rather than overwritten (#12).
...
**Home.** `ARCHITECTURE.md:2133-2143`
...
**Home.** `ARCHITECTURE.md:2078-2094`
