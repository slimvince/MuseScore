...
**Home.** `CLAUDE.md:1012-1014`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1022-1024`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1033-1035`  — a decision about how the work is done, not about the system; this is its correct home.
