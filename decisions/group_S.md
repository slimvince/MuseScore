...
**Home.** `CLAUDE.md:1675-1677`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1685-1687`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1696-1698`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1556-1575`  — a project-wide convention with no owning layer; this is its correct home.
