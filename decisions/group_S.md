...
**Home.** `CLAUDE.md:913-915`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:924-926`  — a decision about how the work is done, not about the system; this is its correct home.
