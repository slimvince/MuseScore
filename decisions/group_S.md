...
**Home.** `CLAUDE.md:1718-1720`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1728-1730`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1599-1618`  — a project-wide convention with no owning layer; this is its correct home.
