...
**Home.** `CLAUDE.md:1725-1727`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1735-1737`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1746-1748`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1606-1625`  — a project-wide convention with no owning layer; this is its correct home.
