...
**Home.** `CLAUDE.md:1454-1456`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `ARCHITECTURE.md:1224-1225`
...
**Home.** `ARCHITECTURE.md:1232-1233`
...
**Home.** `CLAUDE.md:1464-1466`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1475-1477`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `ARCHITECTURE.md:7791-7793`
...
**Home.** `ARCHITECTURE.md:6088-6090`
...
**Home.** `ARCHITECTURE.md:2069-2079`
...
**Home.** `CLAUDE.md:1363-1382`  — a project-wide convention with no owning layer; this is its correct home.
