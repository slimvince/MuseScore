...
**Home.** `CLAUDE.md:161`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:165`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:170`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:196`  — a project-wide convention with no owning layer; this is its correct home.
...
**Home.** `CLAUDE.md:1523-1525`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `ARCHITECTURE.md:1272-1273`
...
**Home.** `ARCHITECTURE.md:1280-1281`
...
**Home.** `CLAUDE.md:1533-1535`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:1544-1546`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `ARCHITECTURE.md:7862-7864`
...
**Home.** `ARCHITECTURE.md:6159-6161`
...
**Home.** `ARCHITECTURE.md:2117-2127`
...
**Home.** `CLAUDE.md:1432-1451`  — a project-wide convention with no owning layer; this is its correct home.
