...
**Home.** `CLAUDE.md:961-963`  — a decision about how the work is done, not about the system; this is its correct home.
...
**Home.** `CLAUDE.md:971-973`  — a decision about how the work is done, not about the system; this is its correct home.
